...
function displayTime() {
    ...
    cronosDiv.innerText = `${hours}:${minutes}:${seconds}:${miliseconds}`;
}
...
function displayHours() {
    ...
    const miliseconds = new Date().getMilliseconds().toString().padStart(3, "0");
    document.getElementById("cronos").innerText = hour + ":" + minute + ":" + second + ":" + miliseconds;
    ...
    // Atualiza o relógio a cada 1 milissegundo
    clockInterval = setInterval(displayTime, 1);
